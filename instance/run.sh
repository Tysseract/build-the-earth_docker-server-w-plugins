...
java -XX:+UseG1GC -Xss${Xss} -Xmx${Xmx} -Xms${Xms} -XX:+DisableExplicitGC -XX:+UnlockExperimentalVMOptions -XX:MaxGCPauseMillis=50 -XX:G1HeapRegionSize=32M -Duser.language=en -Duser.country=US -jar SpongeBootstrap-0.7.1.jar nogui